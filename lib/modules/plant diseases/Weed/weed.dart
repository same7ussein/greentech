...
class WeedScreen extends StatefulWidget {
  const WeedScreen({Key? key}) : super(key: key);
  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<WeedScreen> {
  ...
  Future<void> uploadImage(ImageSource source) async {
    try {
      ...
      final request = http.MultipartRequest("POST", Uri.parse("$url/weed"));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Weed Diseases'),
      ),
